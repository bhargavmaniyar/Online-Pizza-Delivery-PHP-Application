...
<?php
$qry="select * from  employee e, branch b,city ci where b.city_id=ci.id and e.br_id=b.id";
            ...
            <tr>
                    ...
                    <td>
                      <div class="actions text-center">
                          <a class="edit" href="controller/c_employee.php?act=e&id=<?php echo $row[0]?>"><i class="fa fa-pencil"></i></a>
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <a class="delete" href="controller/c_employee.php?act=d&id=<?php echo $row[0]?>"><i class="fa fa-times"></i></a>
                  </div>
                    </td>
                  </tr>
 <?php 
