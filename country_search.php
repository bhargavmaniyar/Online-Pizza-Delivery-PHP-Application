            ...
            <tr>
                    ...
                    <td>
                      <div class="actions text-center">
                          <a class="edit" href="controller/c_country.php?act=e&id=<?php echo $row[0]?>"><i class="fa fa-pencil"></i></a>
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <a class="delete" href="controller/c_country.php?act=d&id=<?php echo $row[0]?>"><i class="fa fa-times"></i></a>
                  </div>
                    </td>
                  </tr>
 <?php 
...
<script>
$("#upcountry").addClass("active");
$("#upcountry").parent().addClass("open");
$("#upcountry").parent().parent().addClass("active");
    </script>