...
{
    header("location: controller/c_category.php?act=s");
}
?>
<!doctype html>
          ...
          <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12">
            <div class="boxed" >
              ...
              <div class="inner no-radius">
                ...
                <form action="controller/c_subcategory.php" method="post" class="basic-form" >
...
if(isset($_SESSION['esubcat']))
{
    $row = $_SESSION['esubcat'];
...
$("#subcat").parent().addClass("open");
$("#subcat").parent().parent().addClass("active");
    </script>
