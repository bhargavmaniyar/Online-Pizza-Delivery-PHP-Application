            ...
            <tr>
                    ...
                    <td>
                      <div class="actions text-center">
                          <a class="edit" href="controller/c_category.php?act=e&id=<?php echo $row[0]?>"><i class="fa fa-pencil"></i></a>
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <a class="delete" href="controller/c_category.php?act=d&id=<?php echo $row[0]?>"><i class="fa fa-times"></i></a>
                  </div>
                    </td>
                  </tr>
 <?php 
...
<script>
$("#upcat").addClass("active");
$("#upcat").parent().addClass("open");
$("#upcat").parent().parent().addClass("active");
    </script>
