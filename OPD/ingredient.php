          ...
          <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12">
            <div class="boxed" >
              ...
              <div class="inner no-radius">
                  ...
                  <form action="controller/c_ingredient.php" method="post" class="basic-form" >
					<input type="hidden" id="act" name="act" value="i"/>
                                        <input type="hidden" id="id" name="id"/>
                  <div class="row">
                  <div class="col-md-12">
                    <label>Name:</label>
                    <input type="text" id="name" name="name" placeholder="Ingredient Name" />
...
$("#ingr").parent().addClass("open");
$("#ingr").parent().parent().addClass("active");
    </script>
