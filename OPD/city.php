...
if(!isset($_SESSION['ddcntry']))
{
    ...
    header("location: controller/c_country.php?act=s?page=city.php");
}
?>
<!doctype html>
          ...
          <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12">
            <div class="boxed" >
              ...
              <div class="inner no-radius">
                ...
                <form action="controller/c_city.php" method="post" class="basic-form" >
                ...
                <?=$_SESSION['ddcntry']  ?>
                  ...
                  <div class="col-md-12">
                    <label>Name:</label>
                    <input type="text" id="name" name="name" placeholder="City Name" />
...
$("#addcity").parent().addClass("open");
$("#addcity").parent().parent().addClass("active");
    </script>
</html>