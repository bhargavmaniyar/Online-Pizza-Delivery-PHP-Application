          ...
          <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12">
            <div class="boxed" >
              ...
              <div class="inner no-radius">
                ...
                <form action="controller/c_country.php" method="post" class="basic-form" >
...
?>
<script>
$("#addcountry").addClass("active");
$("#addcountry").parent().addClass("open");
$("#addcountry").parent().parent().addClass("active");
    </script>
