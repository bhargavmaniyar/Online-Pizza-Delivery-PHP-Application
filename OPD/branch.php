...
if(!isset($_SESSION['ddcntry']))
{
    ...
    header("location: controller/c_country.php?act=s&page=branch.php");
}
?>
<!doctype html>
          ...
          <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12">
            <div class="boxed" >
              ...
              <div class="inner no-radius">
                  ...
                  <form action="controller/c_branch.php" method="post" class="basic-form" >
                ...
                <?=$_SESSION['ddcntry']  ?>
                  ...
                  <div class="col-md-12">
                    <label>Name:</label>
                    <input type="text" id="name" name="name" placeholder="Branch Name" />
    ...
    function ch(a)
    {
        ...
        xmlhttp.onreadystatechange=function(){
          if(xmlhttp.readyState==4 && xmlhttp.status==200)
          {
              ...
              <?php
              if(isset($_SESSION['ebranch']))
              {
                  $row = $_SESSION['ebranch'];
...
<script>
$("#addbranch").addClass("active");
$("#addbranch").parent().addClass("open");
$("#addbranch").parent().parent().addClass("active");
    </script>
</html>